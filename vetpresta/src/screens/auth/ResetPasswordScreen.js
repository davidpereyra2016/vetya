      ...
      >
        <ScrollView contentContainerStyle={styles.scrollView}>
          ...
          <View style={styles.iconContainer}>
            <Ionicons name="lock-closed-outline" size={80} color="#1E88E5" />
          </View>
          ...
          <View style={styles.contentContainer}>
            ...
            <Text style={styles.description}>
              ...
              <Text style={{ fontWeight: 'bold', color: '#1E88E5' }}>{email}</Text>
            </Text>
          ...
          <View style={styles.securityTips}>
            <Text style={styles.securityTitle}>Consejos para una contraseña segura:</Text>
