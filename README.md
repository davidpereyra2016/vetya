...
**Vetya** es una plataforma completa para servicios veterinarios que conecta clientes/dueños de mascotas con prestadores de servicios veterinarios (veterinarios individuales y centros veterinarios) para emergencias en tiempo real y citas programadas y mucho más.
